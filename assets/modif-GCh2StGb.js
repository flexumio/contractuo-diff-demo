const l=`<section>
  ...
  <ol class="multi-level-list legal-list" style="list-style-type:none;">
    <li>
      <p><span class="multi-level-list__marker">1. </span>Project Requirements</p>
      <ol class="multi-level-list legal-list" style="list-style-type:none;">
        <li>
          <p><span class="multi-level-list__marker">1.1. </span>Technical Specifications</p>
        </li>
        <li>
          <p><span class="multi-level-list__marker">1.2. </span>Implementation Plan</p>
        </li>
      </ol>
    </li>
  </ol>
  ...
  <ol class="multi-level-list legal-list" style="list-style-type:none;">
    <li>
      ...
      <ol class="multi-level-list legal-list" style="list-style-type:none;">
        ...
        <li>
          <p><span class="multi-level-list__marker">1.3. </span>Environment setup</p>
        </li>
      </ol>
    </li>
    <li>
  ...
  <ol class="multi-level-list legal-list" style="list-style-type:none;">
    <li>
      ...
      <ol class="multi-level-list legal-list" style="list-style-type:none;">
        ...
        <li>
          <p><span class="multi-level-list__marker">1.2. </span>Risk assessment</p>
        </li>
      </ol>
    </li>
    <li>
    ...
    <li>
      ...
      <ol class="multi-level-list legal-list" style="list-style-type:none;">
        <li>
          ...
          <ol class="multi-level-list legal-list" style="list-style-type:none;">
            <li>
              <p><span class="multi-level-list__marker">1.1.1. </span>Installation guide</p>
            </li>
            <li>
              <p><span class="multi-level-list__marker">1.1.2. </span>User interface</p>
            </li>
          </ol>
        </li>
        <li>
  ...
  <ol class="multi-level-list legal-list" style="list-style-type:none;">
    ...
    <li>
      <p><span class="multi-level-list__marker">2. </span>Schema design</p>
    </li>
    <li>
      <p><span class="multi-level-list__marker">3. </span>Performance tuning</p>
    </li>
    <li>
      <p><span class="multi-level-list__marker">4. </span>Security</p>
    </li>
  </ol>
  ...
  <ol class="multi-level-list legal-list" style="list-style-type:none;">
    <li>
      ...
      <ol class="multi-level-list legal-list" style="list-style-type:none;">
        <li>
          <p><span class="multi-level-list__marker">1.1. </span>Implementation</p>
        </li>
      </ol>
    </li>
    <li>
      <p><span class="multi-level-list__marker">2. </span>Monitoring</p>
      <ol class="multi-level-list legal-list" style="list-style-type:none;">
        <li>
          <p><span class="multi-level-list__marker">2.1. </span>Performance metrics</p>
        </li>
      </ol>
    </li>
  </ol>
